...
public class ResumeTestData {
    ...
    public static Resume getFirstResume() {
        Resume firstResume = new Resume("Григорий Кислин");
        Map<ContactType, String> contactInfo = firstResume.getContacts();
        Map<SectionType, Section> sections = firstResume.getSections();
        ...
        organizationList.add(new Organization(
                ...
                , Collections.singletonList(new Stages(LocalDate.of(2014, 10, 1)
                , LocalDate.of(2016, 1, 1)
                , "Старший разработчик (backend)"
                , "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO."))));
        organizationList.add(new Organization(
                new OrganizationLink("RIT Center", null)
                , Collections.singletonList(new Stages(LocalDate.of(2012, 4, 1)
        ...
        studyList.add(new Organization(new OrganizationLink("Coursera", "https://www.coursera.org/course/progfun")
                , Collections.singletonList(new Stages(LocalDate.of(2013, 3, 1)
        ...
        studyList.add(new Organization(new OrganizationLink("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366")
                , Collections.singletonList(new Stages(LocalDate.of(2011, 3, 1)
        ...
        studyList.add(new Organization(new OrganizationLink("Alcatel", "http://www.alcatel.ru/")
                , Collections.singletonList(new Stages(LocalDate.of(1997, 4, 1)
    ...
    public static Resume getSecondResume() {
        Resume secondResume = new Resume("Николай Жириновский");
        Map<ContactType, String> contactInfo = secondResume.getContacts();
        Map<SectionType, Section> sections = secondResume.getSections();
        contactInfo.put(MOBILE, "+7(999) 999-8888");
        contactInfo.put(SKYPE, "nikolay.girinovsky");
        contactInfo.put(MAIL, "ngirinovsky@yandex.ru");
        contactInfo.put(LINKEDIN, "https://www.linkedin.com/in/ngirinovsky");
        contactInfo.put(GITHUB, "https://github.com/ngirinovsky");
        contactInfo.put(STACKOVERFLOW, "https://stackoverflow.com/users/ngirinovsky");
        contactInfo.put(HOME_PAGE, "http://ngirinovsky.ru/");
        sections.put(OBJECTIVE, new ContentSection("Уборщик"));
        sections.put(PERSONAL, new ContentSection("Идеальные полы, чистые стекла, быстрая работа, все, что вам нужно"));
        List<String> achievements = new ArrayList<>();
        ...
        organizationList.add(new Organization(
                ...
                , Collections.singletonList(new Stages(LocalDate.of(1992, 10, 1)
                , LocalDate.now()
        ...
        studyList.add(new Organization(new OrganizationLink("Dvor", "https://www.dvor.com")
                , Collections.singletonList(new Stages(LocalDate.of(1980, 1, 1)
    ...
    public static Resume getThirdResume() {
        Resume thirdResume = new Resume("Денис Жириновский");
        Map<ContactType, String> contactInfo = thirdResume.getContacts();
        Map<SectionType, Section> sections = thirdResume.getSections();
        contactInfo.put(MOBILE, "+7(888) 888-8888");
        contactInfo.put(SKYPE, "denis.gyrinovsky");
        contactInfo.put(MAIL, "dgyrinovsky@yandex.ru");
        contactInfo.put(LINKEDIN, "https://www.linkedin.com/in/dgyrinovsky");
        contactInfo.put(GITHUB, "https://github.com/dgyrinovsky");
        contactInfo.put(STACKOVERFLOW, "https://stackoverflow.com/users/dgyrinovsky");
        contactInfo.put(HOME_PAGE, "http://dgyrinovsky.ru/");
        sections.put(OBJECTIVE, new ContentSection("Ведущий журналист Гретты Тунберг"));
        sections.put(PERSONAL, new ContentSection("\"Везде плохая экология,отвечаю\""));
        List<String> achievements = new ArrayList<>();
    ...
    public static Resume getFourthResume() {
        Resume fourthResume = new Resume("Владимир Жириновский");
        Map<ContactType, String> contactInfo = fourthResume.getContacts();
        Map<SectionType, Section> sections = fourthResume.getSections();
        contactInfo.put(MOBILE, "+7(777) 777-7777");
        contactInfo.put(SKYPE, "vladimir.girinovsky");
        contactInfo.put(MAIL, "vladimir.girinovsky@yandex.ru");
        contactInfo.put(LINKEDIN, "https://www.linkedin.com/in/vgirinovsky");
        contactInfo.put(GITHUB, "https://github.com/vgirinovsky");
        contactInfo.put(STACKOVERFLOW, "https://stackoverflow.com/users/vgirinovsky");
        contactInfo.put(HOME_PAGE, "http://vgirinovsky.ru/");
        sections.put(OBJECTIVE, new ContentSection("ЛДПР рулит"));
        sections.put(PERSONAL, new ContentSection("Тащу партию с 1993г"));
        List<String> achievements = new ArrayList<>();
